...
function tm_page_transition(){
	
	"use strict";
	
	var section 		= jQuery('.tm_section');
	var allLi 			= jQuery('.transition_link li');
	var button			= jQuery('.transition_link a');
	var wrapper 		= jQuery('.tm_all_wrap');
	...
	button.on('click',function(){
		...
		if(element.parent().hasClass('tm_button')){
...
function tm_trigger_menu(){
	...
	var hamburger 		= jQuery('.tm_topbar .trigger .hamburger');
	var mobileMenu		= jQuery('.tm_mobile_menu');
	var mobileMenuList	= jQuery('.tm_mobile_menu ul li a');
	...
	mobileMenuList.on('click',function(){
		jQuery('.tm_topbar .trigger .hamburger').removeClass('is-active');
		mobileMenu.removeClass('opened');
		return false;
	});
}
...
function tm_news_popup(){
	...
	var modalBox		= jQuery('.tm_modalbox');
	var button			= jQuery('.tm_news .tm_full_link,.tm_news .news_list ul li .metabox .title a');
	var closePopup		= modalBox.find('.close');
...
// -----------------------------------------------------
 ...
 function tm_mycarousel(){
	 
	 "use strict";
	 
	 var carousel			= jQuery('.tm_about .testimonials .owl-carousel');
...
function hashtag(){
	"use strict";
	var ccc 			= $('.tm_header .menu .ccc');
	var element 		= $('.tm_header .menu .active a');
	$('.tm_header .menu a').on('mouseenter',function(){
		var e 			= $(this);
		currentLink(ccc,e);
	});
	$('.tm_header .menu').on('mouseleave',function(){
		element 		= $('.tm_header .menu .active a');
...
function currentLink(ccc,e){
	...
	var menuleft 	= $('.tm_header .menu').offset().left;
